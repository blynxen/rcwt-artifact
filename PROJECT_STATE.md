...
- When the full task/reference block remains present in the new ablation, the tested models stay at ceiling accuracy; this rules out a large cliff-sized semantic-interference effect in this extraction-style setup, not small effects or harder-task interference.
